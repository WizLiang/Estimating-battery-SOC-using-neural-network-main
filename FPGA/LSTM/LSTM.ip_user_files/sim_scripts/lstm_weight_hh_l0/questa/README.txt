...
#
# Generated by export_simulation on Sat Apr 27 14:14:57 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './lstm_weight_hh_l0.sh' script.

./lstm_weight_hh_l0.sh -reset_run
...
./lstm_weight_hh_l0.sh -noclean_files

For more information on the script, please type './lstm_weight_hh_l0.sh -help'.
