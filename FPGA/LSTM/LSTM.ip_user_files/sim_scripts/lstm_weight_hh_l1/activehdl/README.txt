...
#
# Generated by export_simulation on Sat Apr 27 14:28:11 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './lstm_weight_hh_l1.sh' script.

./lstm_weight_hh_l1.sh -reset_run
...
./lstm_weight_hh_l1.sh -noclean_files

For more information on the script, please type './lstm_weight_hh_l1.sh -help'.
