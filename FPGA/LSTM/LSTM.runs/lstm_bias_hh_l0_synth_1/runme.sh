...
HD_PWD='D:/Desktop/Estimating-battery-SOC-using-neural-network-main/FPGA/LSTM/LSTM.runs/lstm_bias_hh_l0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lstm_bias_hh_l0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lstm_bias_hh_l0.tcl
