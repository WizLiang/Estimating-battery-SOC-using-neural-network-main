...
HD_PWD='D:/Desktop/Estimating-battery-SOC-using-neural-network-main/FPGA/LSTM/LSTM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_multiply_cl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_multiply_cl.tcl
