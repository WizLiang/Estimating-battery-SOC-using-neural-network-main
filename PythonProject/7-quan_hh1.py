...
# 加载剪枝并训练好的模型
model_path = save_path + 'model_quantized_ih0_hh0_ih1.pth'
...
def get_trainable_params(model):
    for name, param in model.named_parameters():
        ...
        if name not in ['rnn.weight_ih_l0','rnn.bias_ih_l0','rnn.weight_hh_l0','rnn.bias_hh_l0',\
                        'rnn.weight_ih_l1','rnn.bias_ih_l1','rnn.weight_hh_l1']:
            yield param
...
print('model_quantized_ih0_hh0_ih1_hh1 Done!')
# 保存量化模型
torch.save(model, save_path + 'model_quantized_ih0_hh0_ih1_hh1.pth')